    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <x-form.image-picker
                ...
                label="Ảnh đại diện"
                :multiple="false"
                :value="old('image_original_path', $post->image ?? optional($post->mainImage())->original_path)"
            />
            ...
            <x-form.image-picker
                ...
                label="Banner"
                :multiple="false"
                :value="old('banner_original_path', $post->banner ?? optional($post->bannerImage())->original_path)"
            />
