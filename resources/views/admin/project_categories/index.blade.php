...
@section('content')
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-tools d-flex align-items-center">
                {{-- [MỚI] Nút Bulk Delete --}}
                <button type="button" id="btnBulkDelete" class="btn btn-danger btn-sm mr-2" style="display: none;" onclick="ProjectCategoryManager.submitBulk('delete')">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    ...
                                    {{-- Sửa nút xóa dùng JS chung --}}
                                    <button type="button" class="btn btn-sm btn-danger" 
                                            onclick="ProjectCategoryManager.deleteSingle({{ $category->id }})" title="Xóa">
    ...
    {{-- FORM ẨN BULK ACTION --}}
    <form id="actionForm" action="{{ route('admin.project-categories.bulk_action') }}" method="POST" class="d-none">
        @csrf
